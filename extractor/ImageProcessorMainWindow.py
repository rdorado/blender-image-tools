...
class Ui_ImageProcessorMainWindow(QMainWindow):

    def __init__(self):
        super(Ui_ImageProcessorMainWindow, self).__init__()
        ...
        self.actionApplyCluster = QAction(self)
        self.actionFlipVertical.setObjectName("applyCluster")

        self.actionSegmentate = QAction(self)
        self.actionSegmentate.setObjectName("segmentate")
        
        self.actionFindBorders = QAction(self)
        self.actionFindBorders.setObjectName("findBorders")

        self.actionAcquireSurfaces = QAction(self)
        self.actionAcquireSurfaces.setObjectName("acquireSurfaces")
        ...
        self.menuImage.addSeparator()
        self.menuImage.addAction(self.actionApplyCluster)
        self.menuImage.addAction(self.actionAcquireSurfaces)
        self.menuImage.addSeparator()
        self.menuImage.addAction(self.actionSegmentate)
        self.menuImage.addAction(self.actionFindBorders)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionApplyCluster.setText(_translate("MainWindow", "Apply Cluster"))
        self.actionAcquireSurfaces.setText(_translate("MainWindow", "Acquire Surfaces..."))
        self.actionSegmentate.setText(_translate("MainWindow", "Segmentate"))
        self.actionFindBorders.setText(_translate("MainWindow", "Find Borders"))
