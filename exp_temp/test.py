...
from PySide2.QtWidgets import QWidget, QVBoxLayout, QMainWindow, QGridLayout, QAction, QGroupBox, QRadioButton, QSlider, \
    QLabel, QPushButton, QApplication, QFileDialog, QColorDialog, QMessageBox
from PySide2.QtGui import QIcon, QImage, QPen, QPainter, QColor
