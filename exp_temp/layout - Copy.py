...
from PySide2.QtWidgets import (
  QApplication, QHBoxLayout, QLabel, QStatusBar, QToolBar,
  QAction,
  QGridLayout,
  QMainWindow,
  QMenu,
...
class Ui_MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.gridLayout.addWidget(self.selectpolyButton, 0, 0, Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.eraserButton, 1, 0, Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.fillButton, 1, 1, Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.dropperButton, 2, 0, Qt.AlignTop)

        # Side tools stampButton
        self.stampButton = QPushButton(toolbar)
        self.stampButton.setMinimumSize(QSize(30, 30))
        self.stampButton.setMaximumSize(QSize(30, 30))
        self.stampButton.setText("")
        icon4 = QIcon()
        icon4.addPixmap(QPixmap("icons/cake.png"), QIcon.Normal, QIcon.Off)
        self.stampButton.setIcon(icon4)
        self.stampButton.setCheckable(True)
        self.stampButton.setObjectName("stampButton")
        self.gridLayout.addWidget(self.stampButton, 2, 1, Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.penButton, 3, 0, Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.brushButton, 3, 1, Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.sprayButton, 4, 0, Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.lineButton, 5, 0, Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.polylineButton, 5, 1, Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.rectButton, 6, 0, Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.polygonButton, 6, 1, Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.ellipseButton, 7, 0, Qt.AlignTop)
        ...
        self.gridLayout.addWidget(self.roundrectButton, 7, 1, Qt.AlignTop)
        ...
        #self.documentTabs.addTab(self.canvas, "test1")
